        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVVHash = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransacaoOriginalId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transacoes_Contas_ReceiverAccountId",
                        column: x => x.ReceiverAccountId,
                        principalTable: "Contas",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transacoes_Transacoes_TransacaoOriginalId",
                        column: x => x.TransacaoOriginalId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transacoes_ReceiverAccountId",
                table: "Transacoes",
                column: "ReceiverAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Transacoes_TransacaoOriginalId",
                table: "Transacoes",
                column: "TransacaoOriginalId");
        }
